...
Banner.prototype.start = function () {
  ...
  this.images = ['images/logo.png', 'images/tcs.png', 'images/white_bkg.png', 'images/train.png', 'images/eurostar.png', 'images/scene1_bkg.png', 'images/scene1_clouds.png', 'images/scene1_bus.png', 'images/copy1.png', 'images/scene2_clouds.png', 'images/scene2_bkg.png',
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 1 }).addLabel('start', 0).add([TweenMax.to(this.logo, 1.5, { left: 300, delay: 1 }), TweenMax.to(this.white_bkg, 2.6, { left: 600, delay: 1 }), TweenMax.to(this.train, 7, { left: 10, delay: 1.5, ease: Power2.easeOut, y: 0 }),
  ...
  TweenMax.to(this.scene2_boat, 4, { x: 50, delay: 3.5 }), TweenMax.to(this.scene2_fish, 8, { x: 20, delay: 3.5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 3.5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_boat, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_fish, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_clouds, 1, { autoAlpha: 0, delay: 5 }),
