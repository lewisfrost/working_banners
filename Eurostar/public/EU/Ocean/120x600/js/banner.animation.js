...
Banner.prototype.animate = function () {
  ...
  TweenMax.to(this.scene2_boat, 7, { x: 50, delay: 3.5 }), TweenMax.to(this.scene2_fish, 5, { x: 50, delay: 3.5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 3.5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_boat, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_fish, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene2_clouds, 1, { autoAlpha: 0, delay: 5 }),
