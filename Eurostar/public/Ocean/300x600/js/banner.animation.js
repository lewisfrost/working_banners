...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 2 }).addLabel('start', 0).add([TweenMax.to(this.logo, 2, { autoAlpha: 1 }), TweenMax.to(this.logo, 2, { left: 700, delay: 1 }), TweenMax.to(this.blue_bkg, 2, { left: 700, delay: 1 }), TweenMax.to(this.train, 9, { left: 400, delay: 1.5, ease: Linear.easeNone }),
  ...
  //SCENE 3 PARIS
  TweenMax.to(this.scene3_clouds, 30, { left: -300, delay: 7 }), TweenMax.to(this.scene3_balloon, 9, { y: -100, delay: 7 }), TweenMax.to(this.scene3_bike, 7, { x: -150, delay: 7 }), TweenMax.to(this.scene3_bkg, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene3_balloon, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.copy3, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene3_clouds, 1, { autoAlpha: 0, delay: 10 }),
