...
Banner.prototype.setup = function () {
  ...
  this.scene1_clouds.set({ scale: 1.2, top: -100, left: 30, zIndex: 13 });
  this.scene1_hut.set({ scale: 1.4, top: 10, left: 110, zIndex: 12 });
  this.scene1_man.set({ scale: 1.4, top: 30, left: 130, zIndex: 13 });
  ...
  this.scene2_man.set({ top: 10, left: 200, zIndex: 11 });
...
Banner.prototype.animate = function () {
  ...
  //SCENE 1 ZOOMED IN LONDON
  TweenMax.to(this.scene1_bkg, 2, { scale: 1, y: 50, x: -40, delay: 1.5 }), TweenMax.to(this.scene1_clouds, 2, { scale: 1, y: 50, x: -30, delay: 1.5 }), TweenMax.to(this.scene1_hut, 2, { scale: 1, y: 10, x: -55, delay: 1.5 }), TweenMax.to(this.scene1_man, 2, { scale: 1, y: 35, x: -55, delay: 1.5 }),

  //SCENE 2 ZOOMED OUT LONDON
  TweenMax.to(this.train, 7, { left: 330, delay: 3 }), TweenMax.to(this.scene1_clouds, 11, { x: -200, delay: 3 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 3 }), TweenMax.to(this.copy1, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 6 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.scene1_clouds, 1, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.scene1_man, 0.1, { autoAlpha: 0, delay: 6.5 }),

  //SCENE 3 PARIS
  TweenMax.to(this.scene1_hut, 2, { y: -50, x: 300, rotation: 45, transformOrigin: "left 50%", delay: 7 }), TweenMax.to(this.scene2_clothes1, 0.1, { autoAlpha: 1, delay: 6 }), TweenMax.to(this.scene2_clothes1, 2, { y: -200, x: 280, rotation: 90, transformOrigin: "left 50%", delay: 6.5 }), TweenMax.to(this.scene2_clothes2, 0.1, { autoAlpha: 1, delay: 6 }), TweenMax.to(this.scene2_clothes2, 2, { y: -200, x: 280, rotation: 140, transformOrigin: "left 50%", delay: 7 }), TweenMax.to(this.scene2_clothes3, 0.1, { autoAlpha: 1, delay: 6 }), TweenMax.to(this.scene2_clothes3, 2, { y: -200, x: 280, rotation: 180, transformOrigin: "left 50%", delay: 7.5 }), TweenMax.to(this.scene2_bkg, 0.5, { autoAlpha: 0, delay: 12 }), TweenMax.to(this.scene2_man, 0.5, { autoAlpha: 0, delay: 12 }), TweenMax.to(this.copy3, 1, { autoAlpha: 1, delay: 9 }), TweenMax.to(this.copy3, 0.5, { autoAlpha: 0, delay: 12 }),
