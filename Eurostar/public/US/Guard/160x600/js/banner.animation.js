...
Banner.prototype.setup = function () {
  ...
  this.scene1_hut.set({ scale: 1.4, top: 255, left: 80, zIndex: 12 });
  this.scene1_man.set({ scale: 1.4, top: 305, left: 100, zIndex: 13 });
  this.copy1.set({ autoAlpha: 0, top: 25, left: 35, zIndex: 13 });
  this.copy2.set({ autoAlpha: 0, top: 60, left: 60, zIndex: 13 });
  this.copy3.set({ autoAlpha: 0, top: 95, left: 20, zIndex: 13 });

  //SCENE 2 PARIS
  this.scene2_bkg.set({ zIndex: 10 });
  this.scene2_man.set({ top: 310, left: 60, zIndex: 11 });
  ...
  this.copy4.set({ autoAlpha: 0, scale: 0.4, top: 220, left: 35, zIndex: 7 });
