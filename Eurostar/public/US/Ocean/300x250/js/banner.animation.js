...
Banner.prototype.start = function () {
  ...
  this.images = ['images/logo.png', 'images/white_bkg.png', 'images/blue_bkg.png', 'images/train.png', 'images/scene1_bkg.png', 'images/scene1_clouds.png', 'images/scene1_bus.png', 'images/copy1.png', 'images/scene2_clouds.png', 'images/scene2_bkg.png',
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 1 }).addLabel('start', 0).add([TweenMax.to(this.logo, 2, { left: 500, delay: 1 }), TweenMax.to(this.blue_bkg, 2, { left: -150, delay: 1 }), TweenMax.to(this.white_bkg, 2, { left: 300, delay: 1 }), TweenMax.to(this.train, 7, { left: 150, delay: 1, ease: Power2.easeOut, y: 0 }),
