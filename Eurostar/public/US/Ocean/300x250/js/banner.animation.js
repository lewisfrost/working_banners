...
Banner.prototype.setup = function () {
  ...
  this.copy2.set({ autoAlpha: 0, top: 65, left: 85, zIndex: 11 });
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 1 }).addLabel('start', 0).add([TweenMax.to(this.logo, 1, { left: 700, delay: 1 }), TweenMax.to(this.blue_bkg, 2, { left: 700, delay: 1 }), TweenMax.to(this.train, 9, { left: 150, delay: 1, ease: Power2.easeOut, y: 0 }),

  //SCENE 1 LONDON 
  TweenMax.to(this.scene1_clouds, 8, { left: 0, delay: 1 }), TweenMax.to(this.scene1_bus, 6, { left: -150, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 0, delay: 4 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 4 }), TweenMax.to(this.scene1_clouds, 1, { autoAlpha: 0, delay: 4 }), TweenMax.to(this.scene1_bus, 1, { autoAlpha: 0, delay: 4 }),
  ...
  //SCENE 3 PARIS
  TweenMax.to(this.scene3_clouds, 10, { left: -50, delay: 7 }), TweenMax.to(this.scene3_balloon, 9, { y: -50, delay: 7 }), TweenMax.to(this.scene3_bike, 7, { x: -150, delay: 7 }), TweenMax.to(this.scene3_bkg, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene3_balloon, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.copy3, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene3_clouds, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.train, 0.5, { autoAlpha: 0, delay: 10 }),
