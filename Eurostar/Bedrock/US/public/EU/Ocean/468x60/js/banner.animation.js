...
Banner.prototype.setup = function () {
  ...
  this.scene1_bus.set({ top: 20, left: 300, zIndex: 13 });
  this.copy1.set({ autoAlpha: 0, top: 2, left: 180, zIndex: 13 });

  //SCENE 2 OCEAN
  this.scene2_bkg.set({ top: -10, zIndex: 10 });
  this.scene2_fish.set({ left: 30, top: -18, zIndex: 11 });
  this.copy2.set({ autoAlpha: 0, top: 5, left: 150, zIndex: 11 });

  //SCENE 3 PARIS

  this.scene3_bkg.set({ zIndex: 8 });
  this.scene3_balloon.set({ top: 0, left: 30, zIndex: 9 });
  this.scene3_bike.set({ top: 20, left: 90, zIndex: 9 });
  this.copy3.set({ top: 0, left: 210, zIndex: 9 });
...
Banner.prototype.animate = function () {
  ...
  //SCENE 1 LONDON 
  TweenMax.to(this.scene1_bus, 6, { left: 250, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 1 }), TweenMax.to(this.copy1, 0.5, { autoAlpha: 0, delay: 3 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 3 }), TweenMax.to(this.scene1_bus, 1, { autoAlpha: 0, delay: 3 }),
  ...
  //SCENE 4 LONDON TO PARIS
  TweenMax.to(this.scene4_line1, 1, { y: -12, delay: 8.5 }), TweenMax.to(this.scene4_line2, 1, { y: 30, delay: 8.5 }), TweenMax.to(this.copy4, 1, { autoAlpha: 1, scale: 1, delay: 9 }), TweenMax.to(this.scene4_line1, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.scene4_line2, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.scene4_copy1, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.scene4_copy2, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.copy4, 1, { autoAlpha: 0, delay: 13 }),
