...
Banner.prototype.setup = function () {
  this.logo.set({ left: 6, top: -1, zIndex: 16 });
  this.white_bkg.set({ left: 60, top: 0, zIndex: 15 });
  this.train.set({ top: 335, left: -14000, zIndex: 14 });
  this.eurostar.set({ top: 555, left: 5, zIndex: 14 });
  ...
  this.scene1_hut.set({ scale: 1.4, top: 255, left: 60, zIndex: 12 });
  this.scene1_man.set({ scale: 1.4, top: 305, left: 80, zIndex: 13 });
  this.copy1.set({ autoAlpha: 0, top: 25, left: 15, zIndex: 13 });
  this.copy2.set({ autoAlpha: 0, top: 60, left: 45, zIndex: 13 });
  this.copy3.set({ autoAlpha: 0, top: 95, left: 10, zIndex: 13 });

  //SCENE 2 PARIS
  this.scene2_bkg.set({ zIndex: 10 });
  this.scene2_man.set({ top: 310, left: 40, zIndex: 11 });
  this.scene2_clothes1.set({ autoAlpha: 0, top: 355, left: 60, zIndex: 12 });
  this.scene2_clothes2.set({ autoAlpha: 0, top: 355, left: 60, zIndex: 12 });
  this.scene2_clothes3.set({ autoAlpha: 0, top: 355, left: 60, zIndex: 12 });

  //SCENE 4 LONDON TO PARIS

  this.scene4_bkg.set({ zIndex: 6 });
  this.scene4_line1.set({ top: 230, left: 5, zIndex: 7 });
  this.scene4_line2.set({ top: 245, left: 5, zIndex: 7 });
  this.copy4.set({ autoAlpha: 0, scale: 0.4, top: 220, left: 15, zIndex: 7 });

  //SCENE 5 CTA & PRICE
  this.scene5_price.set({ autoAlpha: 0, top: 220, left: 10, zIndex: 7 });
  this.copy5.set({ autoAlpha: 0, top: 180, left: 5, zIndex: 7 });
  this.cta.set({ autoAlpha: 0, scale: 0.4, top: 310, left: 20, zIndex: 7 });
  this.tcs.set({ autoAlpha: 0, top: 5, left: 25, zIndex: 7 });
};
...
Banner.prototype.animate = function () {
  ...
  //SCENE 1 ZOOMED IN LONDON
  TweenMax.to(this.scene1_bkg, 2, { scale: 1, y: 50, x: -40, delay: 1 }), TweenMax.to(this.scene1_clouds, 2, { scale: 1, y: 100, x: -30, delay: 1 }), TweenMax.to(this.scene1_hut, 2, { scale: 1, y: 30, x: -30, delay: 1 }), TweenMax.to(this.scene1_man, 2, { scale: 1, y: 25, x: -30, delay: 1 }),

  //SCENE 2 ZOOMED OUT LONDON
  TweenMax.to(this.train, 4.1, { left: 160, delay: 2 }), TweenMax.to(this.scene1_clouds, 11, { x: -200, delay: 2 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 2 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 2.5 }), TweenMax.to(this.copy3, 1, { autoAlpha: 1, delay: 3 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 4 }), TweenMax.to(this.scene1_clouds, 1, { autoAlpha: 0, delay: 4 }), TweenMax.to(this.scene1_man, 0.1, { autoAlpha: 0, delay: 5 }),

  //SCENE 3 PARIS
  TweenMax.to(this.scene1_hut, 2, { y: -50, x: 300, rotation: 45, transformOrigin: "left 50%", delay: 5 }), TweenMax.to(this.scene2_clothes1, 0.1, { autoAlpha: 1, delay: 5 }), TweenMax.to(this.scene2_clothes1, 2, { y: -200, x: 120, rotation: 90, transformOrigin: "left 50%", delay: 5.4 }), TweenMax.to(this.scene2_clothes2, 0.1, { autoAlpha: 1, delay: 5 }), TweenMax.to(this.scene2_clothes2, 2, { y: -200, x: 120, rotation: 140, transformOrigin: "left 50%", delay: 5.6 }), TweenMax.to(this.scene2_clothes3, 0.1, { autoAlpha: 1, delay: 5 }), TweenMax.to(this.scene2_clothes3, 2, { y: -200, x: 120, rotation: 180, transformOrigin: "left 50%", delay: 5.8 }), TweenMax.to(this.scene2_bkg, 0.5, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.scene2_man, 0.5, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.copy1, 0.5, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.copy2, 0.5, { autoAlpha: 0, delay: 8 }), TweenMax.to(this.copy3, 0.5, { autoAlpha: 0, delay: 8 }),
  ...
  //SCENE 5 CTA & PRICE
  TweenMax.to(this.scene5_price, 1, { autoAlpha: 1, delay: 13.5 }), TweenMax.to(this.copy5, 1, { autoAlpha: 1, delay: 13.5 }), TweenMax.to(this.tcs, 1, { autoAlpha: 1, delay: 13.5 }), TweenMax.to(this.cta, 1, { autoAlpha: 1, scale: 1, delay: 13.5 }), TweenMax.to(this.cta, 0.5, { scale: 1.05, repeat: 5, yoyo: true, delay: 14 })]);
