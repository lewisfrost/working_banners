...
Banner.prototype.setup = function () {
  ...
  this.scene2_clothes3.set({ autoAlpha: 0, top: 35, left: 370, zIndex: 11 });
...
Banner.prototype.animate = function () {
  ...
  TweenMax.to(this.train, 5, { left: 900, delay: 2 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 2 }), TweenMax.to(this.copy1, 1, { autoAlpha: 0, delay: 3.5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 4 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 5.5 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 5 }), TweenMax.to(this.scene1_man, 0.1, { autoAlpha: 0, delay: 5.5 }),
