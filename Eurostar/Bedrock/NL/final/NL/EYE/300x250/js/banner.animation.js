...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 1 }).addLabel('start', 0).add([TweenMax.to(this.logo, 1.5, { left: 300, delay: 1 }), TweenMax.to(this.white_bkg, 2.6, { left: 600, delay: 1 }), TweenMax.to(this.eurostar, 1, { autoAlpha: 1, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 0, delay: 3 }), TweenMax.to(this.eye, 1, { y: -300, delay: 3.5 }), TweenMax.to(this.scene1_bus, 4, { left: 150, delay: 3.5 }), TweenMax.to(this.train, 5, { left: -3000, delay: 3, ease: Power2.easeOut, y: 0 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 7 }), TweenMax.to(this.scene1_bus, 1, { autoAlpha: 0, delay: 7 }), TweenMax.to(this.eye, 1, { y: 0, delay: 6 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 7 }), TweenMax.to(this.eye, 1, { y: -300, delay: 10 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 9 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 1, delay: 8 }), TweenMax.to(this.train, 3, { left: 150, delay: 10, ease: Power2.easeOut, y: 0 }), TweenMax.to(this.eye, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.train, 0.8, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.eye_bottom, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.eye_top, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.top_eyelash, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.bkg, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.eurostar, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.bkg_bottom, 1, { autoAlpha: 0, delay: 13 }),

  //SCENE 5 CTA & PRICE
  TweenMax.to(this.scene5_price, 1, { autoAlpha: 1, delay: 14 }), TweenMax.to(this.eurostar_yellow, 1, { autoAlpha: 1, delay: 14 }), TweenMax.to(this.copy5, 1, { autoAlpha: 1, delay: 14 }), TweenMax.to(this.cta, 1, { autoAlpha: 1, scale: 1, delay: 14 }), TweenMax.to(this.cta, 0.5, { scale: 1.05, repeat: 5, yoyo: true, delay: 14.5 }), TweenMax.to(this.train, 1, { left: -14000, delay: 15 })]);
