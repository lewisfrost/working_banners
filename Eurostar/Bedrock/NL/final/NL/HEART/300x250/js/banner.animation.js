...
Banner.prototype.setup = function () {
  ...
  this.bike_mum.set({ top: 100, left: -60, zIndex: 19 });
  this.mum_wheel1.set({ top: 148, left: -70, zIndex: 19 });
  this.mum_wheel2.set({ top: 148, left: -25, zIndex: 19 });
  this.bike_dad.set({ top: 100, left: -60, zIndex: 19 });
  this.dad_wheel1.set({ top: 145, left: -70, zIndex: 19 });
  this.dad_wheel2.set({ top: 145, left: -30, zIndex: 19 });
  this.bike_boy.set({ top: 125, left: -70, zIndex: 19 });
  this.boy_wheel1.set({ top: 155, left: -70, zIndex: 19 });
  this.boy_wheel2.set({ top: 155, left: -45, zIndex: 19 });
  this.girl_wheel1.set({ top: 160, left: -70, zIndex: 19 });
  this.girl_wheel2.set({ top: 160, left: -35, zIndex: 19 });
  this.bike_girl.set({ top: 130, left: -70, zIndex: 19 });
  ...
  this.scene2_taxi.set({ top: 145, left: 200, zIndex: 9 });
