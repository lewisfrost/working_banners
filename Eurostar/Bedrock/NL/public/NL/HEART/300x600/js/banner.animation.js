...
Banner.prototype.setup = function () {
  ...
  this.eurostar.set({ autoAlpha: 0, top: 550, left: 95, zIndex: 20 });
  ...
  this.tcs.set({ autoAlpha: 0, top: 380, left: 44, zIndex: 7 });
  this.copy3.set({ autoAlpha: 0, top: 150, left: 78, zIndex: 7 });
  this.cta.set({ autoAlpha: 0, scale: 0.4, top: 350, left: 95, zIndex: 7 });
  this.dutch.set({ autoAlpha: 0, top: 358, left: 95, zIndex: 8 });
  this.english.set({ autoAlpha: 0, top: 358, left: 95, zIndex: 8 });
};
...
Banner.prototype.animate = function () {
  ...
  //SCENE 3 CTA & PRICE
  TweenMax.to(this.scene3_price, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.copy3, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.tcs, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.cta, 1, { autoAlpha: 1, scale: 1, delay: 10 }), TweenMax.to(this.dutch, 1, { autoAlpha: 1, scale: 1, delay: 10 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 0, delay: 11 }), TweenMax.to(this.english, 0.5, { autoAlpha: 1, scale: 1, delay: 11.5 }), TweenMax.to(this.english, 0.5, { autoAlpha: 0, scale: 1, delay: 12.5 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 1, scale: 1, delay: 13 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 0, delay: 14 }), TweenMax.to(this.english, 0.5, { autoAlpha: 1, scale: 1, delay: 14.5 }), TweenMax.to(this.english, 0.5, { autoAlpha: 0, scale: 1, delay: 15.5 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 1, scale: 1, delay: 16 }), TweenMax.to(this.cta, 0.5, { scale: 1.05, repeat: 5, yoyo: true, delay: 16 }), this.timeline.pause()]);
