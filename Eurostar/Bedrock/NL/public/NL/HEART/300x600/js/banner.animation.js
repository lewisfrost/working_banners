...
Banner.prototype.animate = function () {
  ...
  //SCENE 3 CTA & PRICE
  TweenMax.to(this.eurostar_yellow, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.scene3_price, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.copy3, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.tcs, 1, { autoAlpha: 1, delay: 10 }), TweenMax.to(this.cta, 1, { autoAlpha: 1, scale: 1, delay: 10 }), TweenMax.to(this.dutch, 1, { autoAlpha: 1, scale: 1, delay: 10 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 0, delay: 11 }), TweenMax.to(this.english, 0.5, { autoAlpha: 1, scale: 1, delay: 11.5 }), TweenMax.to(this.english, 0.5, { autoAlpha: 0, scale: 1, delay: 12.5 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 1, scale: 1, delay: 13 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 0, delay: 14 }), TweenMax.to(this.english, 0.5, { autoAlpha: 1, scale: 1, delay: 14.5 }), TweenMax.to(this.english, 0.5, { autoAlpha: 0, scale: 1, delay: 15.5 }), TweenMax.to(this.dutch, 0.5, { autoAlpha: 1, scale: 1, delay: 16 }), TweenMax.to(this.cta, 0.5, { scale: 1.05, repeat: 5, yoyo: true, delay: 16 }), this.timeline.pause()]);
