...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({repeat: 1})
    ...
    .add([
      ...
      TweenMax.to(this.train, 5,{ left:-3000, delay: 3,  ease: Power2.easeOut, y: 0}),
      ...
      TweenMax.to(this.train, 3,{ left:150, delay: 10,  ease: Power2.easeOut, y: 0}),

      TweenMax.to(this.eye, 1, { autoAlpha: 0, delay: 13}),
      TweenMax.to(this.train, 0.8, { autoAlpha: 0, delay: 13}),
      ...
      TweenMax.to(this.train, 1, {left:-14000, delay: 15}),
    ])
