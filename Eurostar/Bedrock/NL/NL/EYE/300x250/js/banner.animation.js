...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 1 }).addLabel('start', 0).add([TweenMax.to(this.logo, 1.5, { left: 300, delay: 1 }), TweenMax.to(this.white_bkg, 2.6, { left: 600, delay: 1 }), TweenMax.to(this.eurostar, 1, { autoAlpha: 1, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 1, delay: 1 }), TweenMax.to(this.copy1, 1, { autoAlpha: 0, delay: 3 }), TweenMax.to(this.eye, 1, { y: -300, delay: 3.5 }), TweenMax.to(this.scene1_bus, 4, { left: 150, delay: 3.5 }), TweenMax.to(this.train, 7, { left: 150, delay: 3.5, ease: Power2.easeOut, y: 0 }), TweenMax.to(this.scene1_bkg, 1, { autoAlpha: 0, delay: 7 }), TweenMax.to(this.scene1_bus, 1, { autoAlpha: 0, delay: 7 }), TweenMax.to(this.eye, 1, { y: 0, delay: 6 }), TweenMax.to(this.train, 0.1, { left: -7000, delay: 7.5, ease: Power2.easeOut, y: 0 }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 7 }), TweenMax.to(this.eye, 1, { y: -300, delay: 10 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 9 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 1, delay: 8 }), TweenMax.to(this.train, 5, { left: 150, delay: 8, ease: Power2.easeOut, y: 0 }), TweenMax.to(this.eye, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.train, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.eye_bottom, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.eye_top, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.top_eyelash, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.bkg, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.eurostar, 1, { autoAlpha: 0, delay: 13 }), TweenMax.to(this.bkg_bottom, 1, { autoAlpha: 0, delay: 13 }),
