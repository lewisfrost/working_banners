...
Banner.prototype.setup = function () {
  this.logo.set({ left: 10, top: 270, zIndex: 20 });
  this.white_bkg.set({ left: 80, top: 0, zIndex: 20 });
  this.eurostar.set({ autoAlpha: 0, top: 550, left: 20, zIndex: 20 });
  this.eurostar_yellow.set({ autoAlpha: 0, top: 550, left: 20, zIndex: 20 });

  //SCENE 1 HOLLAND
  this.scene1_bkg.set({ zIndex: 15 });
  this.scene1_windmill.set({ top: 275, left: 72, zIndex: 17 });
  this.scene1_clouds.set({ top: 140, left: 30, zIndex: 16 });
  this.scene1_heart.set({ top: 322, left: -10, zIndex: 17 });
  this.scene1_boat.set({ top: 376, left: 150, zIndex: 18 });
  this.copy1.set({ autoAlpha: 0, top: 50, left: 10, zIndex: 19 });
  ...
  this.train.set({ top: 400, left: -14000, zIndex: 10 });
  this.scene2_london_eye.set({ top: 257, left: 52, zIndex: 9 });
  ...
  this.scene2_heart.set({ top: 320, left: -5, zIndex: 7 });
  this.copy2.set({ autoAlpha: 0, top: 50, left: 15, zIndex: 9 });

  //SCENE 3 CTA & PRICE
  this.scene3_price.set({ autoAlpha: 0, top: 230, left: 17, zIndex: 7 });
  this.tcs.set({ autoAlpha: 0, top: 384, left: -29, zIndex: 7 });
  this.copy3.set({ autoAlpha: 0, top: 150, left: 19, zIndex: 7 });
  this.cta.set({ autoAlpha: 0, scale: 0.4, top: 345, left: 25, zIndex: 7 });
  this.dutch.set({ autoAlpha: 0, top: 353, left: 25, zIndex: 8 });
  this.english.set({ autoAlpha: 0, top: 353, left: 25, zIndex: 8 });
};
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: 1 }).addLabel('start', 0).add([TweenMax.to(this.logo, 1.5, { left: 300, delay: 1 }), TweenMax.to(this.white_bkg, 2.6, { left: 600, delay: 1 }), TweenMax.to(this.eurostar_yellow, 1, { autoAlpha: 1, delay: 2 }),
  ...
  //SCENE 2 LONDON
  TweenMax.to(this.scene2_bus, 2, { left: -150, delay: 6 }), TweenMax.to(this.scene2_taxi, 4, { left: -100, delay: 6 }), TweenMax.to(this.scene2_clouds, 11, { x: -200, delay: 5 }), TweenMax.to(this.scene2_heart, 5, { rotationY: 1080, transformOrigin: "centre", delay: 5, ease: Power2.easeOut }), TweenMax.to(this.scene2_london_eye, 5, { rotation: 1080, transformOrigin: "centre", delay: 5, ease: Power2.easeOut }), TweenMax.to(this.train, 5, { left: 20, delay: 5, ease: Power4.easeOut }), TweenMax.to(this.copy2, 1, { autoAlpha: 1, delay: 5 }), TweenMax.to(this.copy2, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_bus, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_heart, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_bkg, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_taxi, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_london_eye, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.scene2_clouds, 1, { autoAlpha: 0, delay: 10 }), TweenMax.to(this.train, 1, { autoAlpha: 0, delay: 10 }),
