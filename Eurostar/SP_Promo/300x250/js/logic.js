	...
	function frame1Animation(){
		...
		TweenLite.set(".hand",{x:180, alpha:1})
		...
		TweenLite.to('.lid2',3,{rotation: 30, scale:0.8, transformOrigin: "100% 100%", x: 40, y: -220, ease: Power2.easeOut, delay:5.75});
		TweenLite.to('.hand',3,{rotation: 30, scale:0.8, transformOrigin: "100% 100%", x: 80, y: -160, ease: Power2.easeOut, delay:5.75});
	...
	function frame2Animation(){
		...
		TweenLite.to('.copy3',1,{alpha:1, ease:Quad.easeIn, delay: .3});
		TweenLite.to('.copy4',1,{alpha:1, ease:Quad.easeIn, delay: .8});

		TweenLite.to('.track',1,{alpha:1, delay: 1.3});
		TweenLite.to('.train',5,{alpha:1, left: 150, rotationZ:0.03, z:0.03, ease: Power4.easeOut, delay: 1});
		TweenLite.delayedCall(7,frame3Animation)
	}
