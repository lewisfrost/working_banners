...
var idleFlipTime = 1500; // time in milliseconds (1000ms = 1s)
var wtf = false;
var prevFace;
...
function showMainFaces () {
    $('#shell-1').addClass('step1').one('webkitTransitionEnd otransitionend msTransitionEnd transitionend', function () {
        $(this).addClass('inpos').removeClass('step1');
        setTimeout(function () {
            $('#shell-2').addClass('step1').one('webkitTransitionEnd otransitionend msTransitionEnd transitionend', function () {
                $(this).addClass('inpos').removeClass('step1');
                setTimeout( function () {
                    $('#shell-3').addClass('step1').one('webkitTransitionEnd otransitionend msTransitionEnd transitionend', function () {
                        $(this).addClass('inpos').removeClass('step1');
                        setTimeout( function () {
                            $('#shell-4').addClass('step1').one('webkitTransitionEnd otransitionend msTransitionEnd transitionend', function () {
                                $(this).addClass('inpos').removeClass('step1');
                                
									setTimeout( function () {
										$('#shell-5').addClass('step1').one('webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend', function () {
												$(this).addClass('inpos').removeClass('step1');
											setTimeout( function () {
											$('#shell-6').addClass('step1').one('webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend', function () {
												$(this).addClass('inpos').removeClass('step1');	
												setTimeout( function () {
													$('#shell-7').addClass('step1').one('webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend', function () {
														wtf = true;
														$(this).addClass('inpos').removeClass('step1');
													setTimeout( function () {
														$('#shell-8').addClass('step1').one('webkitTransitionEnd oTransitionEnd msTransitionEnd transitionend', function () {
															$(this).addClass('inpos').removeClass('step1');
														});
													}, waitTime);
												});
