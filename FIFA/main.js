...
var SITE = {
	...
	init : function (){
		...
		$( "#backgroundExit" ).bind('touchstart click', function() {
	...
	animateCollapsed : function (whichStep) {
		...
		switch (whichStep){
			...
			case 1 :
				...
				TweenLite.to($( ".mainBg0" ), 0, {alpha:0});
				TweenLite.to($( ".mainBg1" ), 0, {alpha:1});
				TweenLite.to($( ".shard0" ), 0, {alpha:1});
				TweenLite.to($( ".shard1" ), 0, {alpha:1});
				TweenLite.to($( ".shard2" ), 0, {alpha:1});
				TweenLite.to($( ".shard3" ), 0, {alpha:1});
				TweenLite.to($( ".shard4" ), 0, {alpha:1});

				TweenLite.to($( ".shard0" ), 0.5, {rotation:90,delay:1, transformOrigin:"top left",delay:1.3});
				TweenLite.to($( ".shard1" ), 0.5, {rotation:90,delay:1, transformOrigin:"top left",delay:1.1});
				TweenLite.to($( ".shard2" ), 0.5, {rotation:90,delay:1, transformOrigin:"bottom left",delay:0.9});
				TweenLite.to($( ".shard3" ), 0.5, {rotation:90,delay:1, transformOrigin:"top right",delay:0.7});
				TweenLite.to($( ".shard4" ), 0.5, {rotation:90,delay:1, transformOrigin:"bottom right",delay:0.5});
				TweenLite.to($( ".mainBg1" ), 6, {top:-150, ease:Sine.easeInOut});
				TweenLite.to($( ".player" ), 6, {scaleX:1,scaleY:1,ease:Sine.easeIn});
			...
			case 2 :
				...
				TweenLite.to($( ".shard0" ), 0.5, {rotation:0,delay:1, transformOrigin:"top left",delay:1.3});
				TweenLite.to($( ".shard1" ), 0.5, {rotation:0,delay:1, transformOrigin:"top left",delay:1.1});
				TweenLite.to($( ".shard2" ), 0.5, {rotation:0,delay:1, transformOrigin:"bottom left",delay:0.9});
				TweenLite.to($( ".shard3" ), 0.5, {rotation:0,delay:1, transformOrigin:"top right",delay:0.7});
				TweenLite.to($( ".shard4" ), 0.5, {rotation:0,delay:1, transformOrigin:"bottom right",delay:0.5});
				$('.mainBg0').css({'zIndex':'4'})
				//TweenLite.to($( ".mainBg0" ), 0.25, {alpha:1});
				TweenLite.to($( ".mainLogo" ), 0.5, {alpha:1,delay:1.7});
				TweenLite.to($( ".eLogo" ), 0.5, {alpha:1,delay:1.7});
				TweenLite.to($( ".cPegi" ), 0.5, {alpha:1,delay:1.7});
				TweenLite.to($( ".cXbox" ), 0.5, {alpha:1,delay:1.7});
				TweenLite.to($( ".cCtaT" ), 0.5, {alpha:1,delay:2.3,onComplete:function(){
					atEnd = true;
				}});
				TweenLite.to($( ".cCta" ), 0.5, {scaleX:1,delay:1.7});
