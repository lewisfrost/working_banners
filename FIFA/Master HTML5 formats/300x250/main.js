	...
	animateCollapsed : function (whichStep) {
		...
		switch (whichStep){
			...
			case 1 :
				...
				TweenLite.to($( ".shard2" ), 0.5, {rotation:90,delay:1, transformOrigin:"top right",delay:0.9});
				TweenLite.to($( ".shard3" ), 0.5, {rotation:90,delay:1, transformOrigin:"bottom right",delay:0.7});

				TweenLite.to($( ".mainBg1" ), 3, {left:0,delay:1});
			...
			case 2 :
				...
				TweenLite.to($( ".shard2" ), 0.5, {rotation:0,delay:1, transformOrigin:"top right",delay:0.9});
