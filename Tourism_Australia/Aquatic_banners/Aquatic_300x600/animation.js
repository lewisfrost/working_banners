...
ad = {
	...
	clickthrough: function(){
		GET("#innerwrapper").addEventListener('click', function(){window.open(clickTag)});
	},
	animation: function(){
		...
		//1st frame
		tl
		.to('#bg', 5, {right:'-150px', ease: Sine.easeOut})
		.to('#location', 1, {opacity:'1', ease: Sine.easeOut}, 0.1)
		.to('#logo-white', 1, {opacity:'1', ease:Quart.easeOut}, 0.5)
		.to('#title1', 1.5, {opacity:'1', left:'-14px', ease: Sine.easeOut}, 0.9)
		
		.to(['#logo-white','#location', '#title1'], 1, {delay:2, opacity:'0', ease:Quart.easeOut})
		.to('#whiteboard', 1, {opacity:'0.75', ease: Sine.easeOut}, "-=1")
		
		.to('#logo-green', 1, {opacity:'1', left:'100px', ease:Quart.easeOut}, "-=0.3")
		.to('#title3', 1, {opacity:'1', left:'61px', ease:Quart.easeOut}, "-=0.3")	
		.to('.btn1', 1, {opacity:'1', ease: Sine.easeOut}, "-=0.1")
...
function endframe(){ tl.stop(); tl.seek(10); }