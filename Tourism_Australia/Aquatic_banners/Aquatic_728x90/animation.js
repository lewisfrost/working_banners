...
ad = {
	...
	animation: function(){
		...
		tlRepeat.pause();
		tl
		.to('#bg', 8, {delay:0.75, top:'-350px', ease: Sine.easeOut})
		.to('#location', 1, {opacity:'1', ease: Sine.easeOut}, 0.1)
		.to('#logo-white', 1, {opacity:'1', ease:Quart.easeOut}, 0.5)
		.to('#title1', 1.5, {opacity:'1', left:'400px', ease: Sine.easeOut}, 0.9)
		
		.to(['#logo-white','#location', '#title1'], 1, {delay:2, opacity:'0', ease:Quart.easeOut})
		.to('#whiteboard', 1, {opacity:'0.75', ease: Sine.easeOut}, "-=1")
		
		.to('#title3', 1, {opacity:'1', left:'200px', ease:Quart.easeOut}, "-=0.3")
		.to('#logo-green', 1, {opacity:'1', left:'589px', ease:Quart.easeOut}, "-=0.3")
