...
ad = {
	...
	animation: function(){
		...
		.to('#logo-green', 1, {opacity:'1', left:'30px', ease:Quart.easeOut}, "-=0.3")
		.to('#title3', 1, {opacity:'1', left:'6px', ease:Quart.easeOut}, "-=0.3")
