...
ad = {
	...
	animation: function(){
		...
		.to('#location', 1, {opacity:'1', ease: Back.easeOut}, 0.1)
		.to('#logo-white', 1, {opacity:'1', ease:Quart.easeOut}, 0.5)
		.to('#title1', 1, {opacity:'1', left:'-12px', ease: Back.easeOut}, 0.9)
        
		.to(['#logo-white','#location', '.btn1','#title1'], 1, {delay:2, opacity:'0', ease:Quart.easeOut})
		.to('#whiteboard', 1, {opacity:'0.75', ease: Back.easeOut}, "-=1")
		
		.to('#logo-green', 1, {opacity:'1', left:'100px', ease:Quart.easeOut}, "-=0.3")
		.to('#title3', 1, {opacity:'1', left:'0px', ease:Quart.easeOut}, "-=0.3")
