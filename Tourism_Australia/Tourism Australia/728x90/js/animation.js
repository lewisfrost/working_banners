...
ad = {
	...
	animation: function(){
		...
		tl
		.to('#bg', 5, {top:'-200px', ease: Sine.easeOut})
		...
		.to('#bg', 4, {top:'-5px', ease: Sine.easeIn}, 5)
		
		.to(['#logo-white2','#partner-logo2'], 1, {opacity:'1', ease:Quart.easeOut}, "+=0.2")
		.to('#title4', 1, {opacity:'1', ease:Quart.easeOut}, "+=0.2")
		.to(['.btn1','#tcs'], 1, {opacity:'1', ease: Back.easeOut}, "+=0.1")
