...
function init() {
    ...
    TweenLite.to(prod2, '0', {top: 65, left: 45, scaleX: '.75', scaleY: '.75'});
...
function stepAnim(fr) {
    ...
    switch (fr) {
        // Initial frame
        case 0:
           // TweenLite.to(blackTop, '1', {delay:0.8, top: 30, ease:Quad.easeInOut});
       ...
       case 1:
        ...
        case 2:
            ...
            TweenLite.to(cta, '1', {top:-26, delay:1.5});
