...
function init() {
    ...
    TweenLite.to(prod2, '0', {top: 220, left: 40, scaleX: '.75', scaleY: '.75'});
...
function stepAnim(fr) {
    ...
    switch (fr) {
        // Initial frame
        case 0:
            TweenLite.to(blackTop, '2', {delay:0.8, top: 80, ease:Quad.easeInOut});
            TweenLite.to(blackBottom, '2', {delay:0.8, top: 300, ease:Quad.easeInOut});            
            TweenLite.to(bkg, '1', {delay:1, top: 0, scaleX:'1', scaleY:'1', transformOrigin:"left 50%"});
            TweenLite.to(prod2, '2', {delay:2.5, scaleX: '1', scaleY:'1', left:0, top:130, ease:Quad.easeInOut});
            jumpFrame(3);
        break;

       case 1:
            TweenLite.to(blackTop, '1', {delay:1,opacity:0, ease:Quad.easeInOut});
            TweenLite.to(blackBottom, '0.8', {delay:1,opacity:0, ease:Quad.easeInOut});  
            ...
            jumpFrame(4);
            TweenLite.to(lineH, speedTransition*2, {left:0, width: 160, delay:1.5, ease:Quad.easeInOut});
			TweenLite.to(lineV, speedTransition*3, {top:0, height: 600, delay:1.5});
			TweenLite.to(ribbon, speedTransition*2, {opacity: 1, delay:2, ease:Quad.easeInOut});
            TweenLite.to(prod1, '1.5', {top:135, opacity:1, delay:2.5, ease:Quad.easeInOut});
            TweenLite.to(prod3, '1.5', {top:135, opacity:1, delay:3, ease:Quad.easeInOut});
        break;
        
        case 2:
            
            TweenLite.to(copy1, '1', {opacity: 0, ease:Quad.easeInOut});
            TweenLite.to(copy3, '1', {top:-45, opacity: 1, delay:1.5, ease:Quad.easeInOut});
            TweenLite.to(prod2, '1.5', {top:-50, delay:1.5, ease:Quad.easeInOut});
            TweenLite.to(prod1, '1.5', {top:-50, delay:1.5, ease:Quad.easeInOut});
            TweenLite.to(prod3, '1.5', {top:-50, delay:1.5, ease:Quad.easeInOut});
            TweenLite.to(cta, '1', {top:-45, opacity: 1, delay:2.0, ease:Quad.easeInOut});
