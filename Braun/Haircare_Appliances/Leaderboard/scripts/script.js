...
function stepAnim(fr) {
    ...
    switch (fr) {
        // Initial frame
        case 0:
            TweenLite.to(prod2, '0.5', {top:0, ease:Quad.easeInOut});
            //TweenLite.to(copy1, '1', {delay:2, opacity: 0, ease:Quad.easeInOut});
            TweenLite.to(blackTop, '1', {delay:2, top:-40});
            TweenLite.to(blackBottom, '1', {delay:2, top: 40});            
            TweenLite.to(bkg, '1', {delay:1, top: 0, scaleX:'1', scaleY:'1', transformOrigin:"left 50%"});
            TweenLite.to(prod2, '2', {delay:3, left: -500, ease:Quad.easeInOut});
            jumpFrame(3);
        break;
       ...
       case 1:
            ...
            jumpFrame(4);
            TweenLite.to(lineH, speedTransition*3, {left:0, width: 728, delay:.1, ease:Quad.easeInOut});
			TweenLite.to(lineV, speedTransition*3, {height: 90, delay:.3,  ease:Quad.easeInOut});
			TweenLite.to(ribbon, speedTransition*2, {opacity: 1, delay:1, ease:Quad.easeInOut});
            TweenLite.to(prod1, '1', {top:30, autoAlpha:1, delay:1.5, ease:Quad.easeInOut});
            TweenLite.to(prod3, '1', {top:30, autoAlpha:1, delay:2, ease:Quad.easeInOut});
        break;
        
        case 2:
            TweenLite.to(prod1, '1', {top:0, autoAlpha:1, delay:2.5, ease:Quad.easeInOut});
            TweenLite.to(prod3, '1', {top:0, autoAlpha:1, delay:3, ease:Quad.easeInOut});
            ...
            //TweenLite.to(tcs, '1', {opacity: 1, delay:1.5});
			jumpFrame(3);
        break;

        case 3:
            TweenLite.to(copy4, '1', {opacity: 1, ease:Quad.easeInOut});//, onComplete:jumpFrame, onCompleteParams:[4]});
            TweenLite.to(offerBar, '1', {top:65, autoAlpha:1, delay:1, ease:Quad.easeInOut});
        break;
