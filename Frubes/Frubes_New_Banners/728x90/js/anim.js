...
function startAnim() {
   console.log("startAnim");
    ...
    TweenLite.set(minimo, {visibility:"visible",opacity:1,y:90});
    ...
    TweenLite.set(txt1, {visibility:"visible",y:-90,opacity:1});
    ...
    TweenLite.to([".txt1"],1,{y:90, ease: Power4.easeInOut, delay:3});
    ...
    TweenLite.to([".txt2",".pack"],1,{y:90, ease: Power4.easeInOut, delay:8});
