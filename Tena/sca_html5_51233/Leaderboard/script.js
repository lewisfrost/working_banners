...
function init() {
    ...
    bkg.style.top = '0px';
    copy0.style.left =  copy2.style.left = copy1.style.left = '-350px';
    copy3.style.left ='-390px';
    regular.style.left = '65px';
    copy3b.style.width = '0px';
    copy3b.style.left = '110px';
    product.style.left = '800px';
    arrow.style.left = '288px';
...
function stepAnim(fr) {
    ...
    switch (fr) {
        ...
        case 1:
            TweenLite.to(bkg, speedTransition, {top: -40});
        ...
        case 2:
            ...
            TweenLite.to(copy0, speedTransition, {left: 800});
            TweenLite.to(regular, speedTransition, {left:800, delay:'5'});
			TweenLite.to(copy1, speedTransition, {left: 20});
            TweenLite.to(copy2, speedTransition, {left: 335});
			jumpFrame(5);
        break;

        case 3:
            TweenLite.to(copy1, speedTransition, {left: 800});
            TweenLite.to(copy2, speedTransition, {left: 800});
        ...
        case 4:
            TweenLite.to(copy3, speedTransition, {left: 800});
            TweenLite.to(copy3b, speedTransition, {left: 800});
            TweenLite.to([cta, arrow], 1, {alpha: 1, onComplete: arrowAnimation, delay: '0.5'});
            TweenLite.to(product, speedTransition, {left: 560, delay: '0.5'});
            jumpFrame(4);
        break;
...
function arrowAnimation()
{
    ...
    if( arrowCounter <= 3)
    {
        TweenLite.fromTo(arrow,.35,{left:288},{left:291, overwrite:false, delay:.5 })
        TweenLite.to(arrow,.35,{left:288, delay:2, overwrite:false,delay:.75, onComplete:arrowAnimation})
    }
}
