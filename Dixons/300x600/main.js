...
function onMouseOverHandler(){
    ...
    TweenMax.to(_l, .25, {top:205, ease:Quad.easeOut});
}

function onMouseOutHandler(){
    TweenMax.to(_l, .25, {top:575, ease:Quad.easeIn, onComplete:function(){
        isLegalOpen = true;
...
//    var total = id === DISHWASHER?divs.length-1:divs.length;
    ...
    if(!detectIE()){
        ...
        TweenMax.to("#"+id, 10, {scaleX:1.1, scaleY:1.1, x:-20, y:-13, force3D:true, transformOrigin:"50% 50%"});
    }
...
function onApplianceComplete(id){
    ...
    switch(id){
        case OVEN:
            TweenMax.to("#oven", .5, {opacity:0, ease:Quad.easeOut, delay:3, onComplete:playAppliance, onCompleteParams:[HOB]});
            TweenMax.to("#l1", .5, {opacity:0, delay:2, ease:Quad.easeOut});
            TweenMax.to("#l22", .5, {opacity:1, delay:2.5, ease:Quad.easeOut});
            break;
...
//            TweenMax.to("#l32", .5, {opacity:1, delay:5.5, ease:Quad.easeOut});
            break;
