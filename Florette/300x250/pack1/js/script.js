...
var tlM = new TimelineMax({repeat:0});
	 ...
	 //Labels
       ...
       //Eyes
        .to('.eye-black-left', 0.8, {x:-1,y:-3, ease: Sine.easeInOut}, 'eye01')
        .to('.eye-black-right', 0.8, {x:-1,y:-3, ease: Sine.easeInOut}, 'eye01')
        
        .to('.eye-black-left', 0.8, {x:0,y:-1, ease: Sine.easeInOut}, 'eye02')
        .to('.eye-black-right', 0.8, {x:0,y:-1, ease: Sine.easeInOut}, 'eye02')
		...
		.to('#Florette-Made-With-Sunshine', 2.7, {y:-135, ease: Power3.easeOut}, 'Txt1+=0.2')
		.to('#Florette-Tasty', 2.7, {y:-105, ease: Power3.easeOut}, 'Txt1+=0.5')
		...
		.to('#Florette-Tasty', 0.5, {opacity:0}, 'outro')
		.to('#Florette-Packshot', 1.2, {y:0, ease: Power3.easeIn}, 'outro+=0.1')
		.to('#Florette-Recipe', 0.9, {opacity:1}, 'outro+=1')
		.to('#Florette-Win', 0.9, {opacity:1}, 'outro+=1.3')
