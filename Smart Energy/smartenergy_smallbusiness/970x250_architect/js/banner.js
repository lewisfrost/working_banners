...
function showSidePanels(){
    ...
    TweenLite.to(rightp, panelSpeed, {left:783, ease:Quad.easeOut});
    TweenLite.to(controls, panelSpeed, {left:169, ease:Quad.easeOut});
...
function hideSidePanels(){
    ...
    TweenLite.to(leftp, panelSpeed/2, {left:-524, ease:Quad.easeOut});
