...
var imgArr2 = ['flip20','flip19','flip18','flip17','flip16','flip15','flip14','flip13','flip12',
...
function frame1Anim(){
	 ...
	 tw.to(mask,3, {width:266, ease: Power4.easeOut, delay:0.5})
	 tw.delayedCall(5,frame2Anim)
}

function frame2Anim(){
     tw.to(copy1,1, {alpha:0, ease:Quad.easeOut, delay:.6})
	 tw.to(mask,2, {width:34, ease: Power4.easeInOut, delay:0})
