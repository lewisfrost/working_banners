...
function frame1Anim(){
	 ...
	 tw.to(mask,3, {width:180, ease: Power4.easeOut, delay:0.5})
	 tw.delayedCall(5,frame2Anim)
}

function frame2Anim(){
     tw.to(copy1,0.65, {alpha:0, ease:Quad.easeInOut, delay:.6})
	 tw.to(mask,2, {width:17, ease: Power4.easeInOut, delay:0})
...
function frame5Anim(){
     ...
     tw.set(flip19,{alpha:0, delay:0.})
     tw.set(flip20,{alpha:1, delay:0})

     tw.set(flip20,{alpha:0, delay:0.05})
     tw.set(flip21,{alpha:1, delay:0.05})

     tw.set(flip21,{alpha:0, delay:0.10})
     tw.set(flip22,{alpha:1, delay:0.10})

     tw.set(flip22,{alpha:0, delay:0.15})
     tw.set(flip23,{alpha:1, delay:0.15})

     tw.set(flip23,{alpha:0, delay:0.20})
     tw.set(flip24,{alpha:1, delay:0.20})

     tw.set(flip24,{alpha:0, delay:0.25})
     tw.set(flip25,{alpha:1, delay:0.25})

     tw.set(flip25,{alpha:0, delay:0.30})
     tw.set(flip26,{alpha:1, delay:0.30})

     tw.set(flip26,{alpha:0, delay:0.35})
     tw.set(flip27,{alpha:1, delay:0.35})

     tw.set(flip27,{alpha:0, delay:0.40})
     tw.set(flip28,{alpha:1, delay:0.40})

     tw.set(flip28,{alpha:0, delay:0.45})
     tw.set(flip29,{alpha:1, delay:0.45})

     tw.set(flip29,{alpha:0, delay:0.50})
     tw.set(flip30,{alpha:1, delay:0.50})

     tw.set(flip30,{alpha:0, delay:0.55})
     tw.set(flip31,{alpha:1, delay:0.55})

     tw.set(flip31,{alpha:0, delay:0.60})
     tw.set(flip32,{alpha:1, delay:0.60})

     tw.set(flip32,{alpha:0, delay:0.65})
     tw.set(flip33,{alpha:1, delay:0.65})

     tw.set(flip33,{alpha:0, delay:0.70})
     tw.set(flip34,{alpha:1, delay:0.70})

     tw.set(flip34,{alpha:0, delay:0.75})
     tw.set(flip35,{alpha:1, delay:0.75})

     tw.set(flip35,{alpha:0, delay:0.80})
     tw.set(flip36,{alpha:1, delay:0.80})

     tw.set(flip36,{alpha:0, delay:0.85})
     tw.set(flip37,{alpha:1, delay:0.85})

     tw.set(flip37,{alpha:0, delay:0.90})
     tw.set(flip38,{alpha:1, delay:0.90})

     tw.set(flip38,{alpha:0, delay:0.95})
     tw.set(flip39,{alpha:1, delay:0.95})

     tw.set(flip39,{alpha:0, delay:1.0})
     tw.set(flip40,{alpha:1, delay:1.0})

     tw.set(flip40,{alpha:0, delay:1.05})
     tw.set(flip41,{alpha:1, delay:1.05})

     tw.set(flip41,{alpha:0, delay:1.10})
     tw.set(flip42,{alpha:1, delay:1.10})

     tw.set(flip42,{alpha:0, delay:1.15})
     tw.set(flip43,{alpha:1, delay:1.15})

     tw.set(flip43,{alpha:0, delay:1.20})
     tw.set(flip44,{alpha:1, delay:1.20})
}
