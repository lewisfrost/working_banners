...
function frame1Anim(){
     ...
     tw.to(mask,2, {width:550, ease: Power4.easeOut, delay:0.5})
     tw.delayedCall(5,frame2Anim)
}

function frame2Anim(){
     tw.to(copy1,1, {alpha:0, ease:Quad.easeOut, delay:.6})
     tw.to(mask,2, {width:449, ease: Power4.easeInOut, delay:0})

     tw.to(mask2,1, {height:80, ease: Power4.easeOut, delay:1.7})
