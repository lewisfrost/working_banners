...
function frame1Anim(){
	 ...
	 tw.to(mask,3, {width:740, ease: Power4.easeOut, delay:0.5})
	 tw.delayedCall(5,frame2Anim)
}

function frame2Anim(){
     tw.to(copy1,0.65, {alpha:0, ease:Quad.easeInOut, delay:.6})
	 tw.to(mask,2, {width:542, ease: Power4.easeInOut, delay:0})
...
function frame3Anim(){
	...
	tw.to(mask2,2, {width:740, ease: Quad.easeInOut, delay:0.5})
	tw.delayedCall(7,frame4Anim)
}

function frame4Anim(){
	 tw.to(mask2,2, {width:542, ease: Power4.easeInOut, delay:0})
