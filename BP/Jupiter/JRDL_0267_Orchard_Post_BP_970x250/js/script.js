...
function initbanner(){
	...
	frame1Anim()
     ...
     tw.set(flip24,{alpha:0, delay:1.20})
     tw.set(flip25,{alpha:1, delay:1.20})
}
...
function frame2Anim(){
	 ...
	 tw.to(mask,2, {width:458, ease: Power4.easeInOut, delay:0})
...
function frame5Anim(){
	tw.to(cta,0.65, {alpha:1, ease:Quad.easeInOut, delay:1.0})
     ...
     tw.set(flip25,{alpha:0, delay:0})
     tw.set(flip26,{alpha:1, delay:0})

     tw.set(flip26,{alpha:0, delay:0.05})
     tw.set(flip27,{alpha:1, delay:0.05})

     tw.set(flip27,{alpha:0, delay:0.10})
     tw.set(flip28,{alpha:1, delay:0.10})

     tw.set(flip28,{alpha:0, delay:0.15})
     tw.set(flip29,{alpha:1, delay:0.15})

     tw.set(flip29,{alpha:0, delay:0.20})
     tw.set(flip30,{alpha:1, delay:0.20})

     tw.set(flip30,{alpha:0, delay:0.25})
     tw.set(flip31,{alpha:1, delay:0.25})

     tw.set(flip31,{alpha:0, delay:0.30})
     tw.set(flip32,{alpha:1, delay:0.30})

     tw.set(flip32,{alpha:0, delay:0.35})
     tw.set(flip33,{alpha:1, delay:0.35})

     tw.set(flip33,{alpha:0, delay:0.40})
     tw.set(flip34,{alpha:1, delay:0.40})

     tw.set(flip34,{alpha:0, delay:0.45})
     tw.set(flip35,{alpha:1, delay:0.45})

     tw.set(flip35,{alpha:0, delay:0.50})
     tw.set(flip36,{alpha:1, delay:0.50})

     tw.set(flip36,{alpha:0, delay:0.55})
     tw.set(flip37,{alpha:1, delay:0.55})

     tw.set(flip37,{alpha:0, delay:0.60})
     tw.set(flip38,{alpha:1, delay:0.60})

     tw.set(flip38,{alpha:0, delay:0.65})
     tw.set(flip39,{alpha:1, delay:0.65})

     tw.set(flip39,{alpha:0, delay:0.70})
     tw.set(flip40,{alpha:1, delay:0.70})

     tw.set(flip40,{alpha:0, delay:0.75})
     tw.set(flip41,{alpha:1, delay:0.75})

     tw.set(flip41,{alpha:0, delay:0.80})
     tw.set(flip42,{alpha:1, delay:0.80})

     tw.set(flip42,{alpha:0, delay:0.85})
     tw.set(flip43,{alpha:1, delay:0.85})

     tw.set(flip43,{alpha:0, delay:0.90})
     tw.set(flip44,{alpha:1, delay:0.90})

     tw.set(flip44,{alpha:0, delay:0.95})
     tw.set(flip45,{alpha:1, delay:0.95})

     tw.set(flip45,{alpha:0, delay:1.0})
     tw.set(flip46,{alpha:1, delay:1.0})

     tw.set(flip46,{alpha:0, delay:1.05})
     tw.set(flip47,{alpha:1, delay:1.05})

     tw.set(flip47,{alpha:0, delay:1.10})
     tw.set(flip48,{alpha:1, delay:1.10})

     tw.set(flip48,{alpha:0, delay:1.15})
     tw.set(flip49,{alpha:1, delay:1.15})

     tw.set(flip49,{alpha:0, delay:1.20})
     tw.set(flip50,{alpha:1, delay:1.20})
