...
Banner.prototype.setup = function() {
  ...
  this.bg.set({autoAlpha: 0, y: 10, scale: 0.9});

  this.woman.set({autoAlpha: 0, right: -30, bottom: -50, scale: 0.8});

  this.logo.centerHorizontal();
  this.logo.set({top: 19});

  this.copy.centerHorizontal();
  this.copy.set({top: 69});
  this.copyA.set({autoAlpha: 0});

  this.cta.centerHorizontal();
  this.cta.set({top: 486, autoAlpha: 0});
  this.ctaArrows.centerHorizontal();
  this.ctaArrows.set({x: 28, y: 38});
...
Banner.prototype.animate = function() {
  this.tl = new TimelineLite()
    ...
    .add([
      ...
      TweenLite.to(this.woman, 0.8, {autoAlpha: 1, delay: 1}),
      TweenLite.to(this.woman, 8, {y: 50, x: 2, scale: 1, ease: Quad.easeInOut}),
      TweenLite.to(this.bg, 5, {scale: 1, y: 50, ease: Quad.easeInOut}),
