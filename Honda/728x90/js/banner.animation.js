...
Banner.prototype.setup = function() {
  ...
  this.bg.set({autoAlpha: 0, scale: 0.9, x: -58, y: -6});

  this.logo.set({top: 14, right: 18, x: 10});

  this.copyA.centerHorizontal();
  this.copy.set({top: 30, left: 90});
  this.copyA.set({autoAlpha: 0});

  this.cta.centerHorizontal();
  this.cta.set({top: 30, left: 90, autoAlpha: 0});
  this.ctaCopy.set({x: -6});
  this.ctaArrows.set({x: 220, y: 20});
...
Banner.prototype.animate = function() {
  this.tl = new TimelineLite()
    ...
    .add([
      ...
      TweenLite.to(this.bg, 5, {scale: 1, ease: Quad.easeInOut}),
      TweenLite.to(this.copyA, 2, {autoAlpha: 1, delay: 3}),
      TweenLite.to(this.copyA, 2, {autoAlpha: 0, delay: 5}),
      TweenLite.to(this.cta, 2, {autoAlpha: 1, delay: 7}),
      TweenLite.to(this.fuelFiguresButton, 1, {autoAlpha: 1, delay: 9})
    ])
