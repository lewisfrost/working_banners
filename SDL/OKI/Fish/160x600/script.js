...
function startBanner() { 
	...
	tl.set(["#bigfishL7","#bigfishL8"],{x:165, autoAlpha:1});
	tl.set(["#bigfishL9"],{x:260, autoAlpha:1});


	
	
	tl.set(["#Smallfish1","#Smallfish2","#Smallfish3","#Smallfish4","#Smallfish5","#Smallfish6"],{x:162, autoAlpha:1});
		tl.set(["#Smallfish1"],{x:250, autoAlpha:1});
    ...
    tl.add("sequence 1");
		...
		tl.to("#bigfishL9",6,   {autoAlpha:1, x:0, rotationZ:0.003, ease: Sine.easeOut}, "-=10");
		...
		tl.to("#bigfishL7",10,   {autoAlpha:1, x:0, rotationZ:0.003, ease: Sine.easeOut}, "-=11.2");
		tl.to("#bigfishL8",10,   {autoAlpha:1, x:0, rotationZ:0.003, ease: Sine.easeOut}, "-=11.7");
		...
		tl.to("#fish_animation",3,  {scale:1.2, y:-78, x:0, force3D:true, ease: Sine.easeOut, rotationZ:0.03, rotation:0.03},"-=2");
		tl.to("#bg",3,  {autoAlpha:1, y:18, ease: Sine.easeOut,},"-=3");
	
        tl.to("#type_1", 0.3, {autoAlpha:1},"-=2");
        tl.to("#type_1", 0.3, {autoAlpha:0}, "-=0");
       	 tl.to("#type_2", 0.3, {autoAlpha:1}, "+=0");
        tl.to("#type_2", 0.7, {autoAlpha:0}, "+=2");
		tl.to(["#fish_animation","#bg"],0.7,  {alpha:0},"-=0.5");
    
  
   tl.add("sequence 2");
        tl.set(["#white_box"], {autoAlpha:1});
		tl.to("#end_frame", 0.5, {autoAlpha:1}, "+=0");
        tl.from("#white_box", 0.5, {ease: Sine.easeOut, y:255}, "-=0");
...
function bigfishR1_anim() { 
	...
	tl.set(["#bigfishR1","#bigfishR3"],{x:-350, autoAlpha:1});
	tl.set(["#bigfishR6"],{x:-250, autoAlpha:1});
	tl.set(["#bigfishR4","#bigfishR5"],{x:-150, autoAlpha:1});
	tl.set(["#bigfishR8"],{x:-250, autoAlpha:1});
	tl.set(["#bigfishR9"],{x:-100, autoAlpha:1});
	tl.set(["#bigfishR7"],{x:-290, autoAlpha:1});
	tl.set(["#bigfishR2"],{x:-325, autoAlpha:1});
	...
	tl.to("#bigfishR1",10,   {autoAlpha:1, x:0,  rotationZ:0.003, ease: Sine.easeOut},"-=0");
	tl.to("#bigfishR8",6,    {autoAlpha:1, x:0,   rotationZ:0.003, ease: Sine.easeOut},"-=9");
	
	tl.to("#bigfishR2",10,   {autoAlpha:1, x:0,  rotationZ:0.003, ease: Sine.easeOut},"-=9.8");
	tl.to("#bigfishR9",6,    {autoAlpha:1, x:0,   rotationZ:0.003, ease: Sine.easeOut},"-=7");
	...
	tl.to("#bigfishR7",10,   {autoAlpha:1, x:0,  rotationZ:0.003, ease: Sine.easeOut},"-=9.8");
...
function fing_animation() { 
    ...
    // timeline
    var tl = new TimelineMax({repeat: 11, repeatDelay: 0});
	
	tl.to(["#fingL1","#fingL2","#fingL3","#fingL4","#fingL5","#fingL6","#fingL7","#fingL9","#fingR1","#fingR2","#fingR3","#fingR4","#fingR5","#fingR6","#fingR7","#fingR8"],0.3,   {rotation:7, scaleX:0.9, rotationZ:0.003, ease: Sine.easeOut, force3D:true});
	tl.to(["#fingL1","#fingL2","#fingL3","#fingL4","#fingL5","#fingL6","#fingL7","#fingL9","#fingR1","#fingR2","#fingR3","#fingR4","#fingR5","#fingR6","#fingR7","#fingR8"],0.3,   { rotation:-7, rotationZ:0.003, ease: Sine.easeOut, force3D:true});
	tl.to(["#fingL1","#fingL2","#fingL3","#fingL4","#fingL5","#fingL6","#fingL7","#fingL9","#fingR1","#fingR2","#fingR3","#fingR4","#fingR5","#fingR6","#fingR7","#fingR8"],0.3, {rotation:0, scaleX:1, rotationZ:0.003, ease: Sine.easeOut, force3D:true});
