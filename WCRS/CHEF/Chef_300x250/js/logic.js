...
function frame1Animation(){
	TweenLite.set([img1,logo1],{opacity:1});
...
function frame3Animation(){
	TweenLite.to([copy2,logo1],0.65,{opacity:0, ease:Quad.easeOut, delay:0});
	TweenLite.to(gradient,0.65,{opacity:1, ease:Quad.easeIn, delay:0});
	TweenLite.to(logo2,0.65,{opacity:1, ease:Quad.easeIn, delay:0.65});
	TweenLite.to(end_copy1,0.65,{opacity:1, ease:Quad.easeIn, delay:1.3});
	TweenLite.to(cta,0.65,{opacity:1, ease:Quad.easeIn, delay:1.65});
}
